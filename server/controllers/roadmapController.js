...
export const updateRoadmap = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Roadmap updated successfully", data: updatedRoadmap });
  } catch (error) {
...
export const assignRoadmapToStudent = async (req, res) => {
  try {
    ...
    if (!roadmapId || !studentId) {
      return res
        .status(400)
        .json({ message: "Roadmap ID and student ID are required" });
    }
    ...
    const studentExistingRoadmap = await Roadmap.findOne({
      studentId: studentId,
    });
...
export const updateTask = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Task updated successfully", data: updatedRoadmap });
  } catch (error) {
...
export const deleteTask = async (req, res) => {
  try {
    ...
    if (!roadmapId || !taskId) {
      return res
        .status(400)
        .json({ message: "Roadmap ID and task ID are required" });
    }
    ...
    res
      .status(200)
      .json({ message: "Task deleted successfully", data: updatedRoadmap });
  } catch (error) {
